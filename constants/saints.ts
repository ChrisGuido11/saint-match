...
export const SAINTS: Saint[] = [
  ...
  },
  {
    ...
    feastDay: 'August 28',
    bio: 'Brilliant theologian who lived years enslaved to lust and sexual sin before his dramatic conversion. He famously prayed "Grant me chastity, but not yet." His Confessions show that even the deepest struggles with temptation can be overcome by grace.',
    virtues: ['conversion', 'chastity', 'honesty'],
  ...
  },
  {
    ...
    feastDay: 'January 28',
    bio: 'The "Angelic Doctor" who synthesized faith and reason in his Summa Theologica. When his family locked him up and sent a temptress to break his vocation, he drove her away and was granted a miraculous gift of purity. His disciplined mind conquered both intellectual chaos and physical temptation.',
    virtues: ['wisdom', 'purity', 'discipline'],
    emotions: ['scattered', 'overwhelmed'],
    initials: 'TQ',
  },
  {
  ...
  },
  {
    ...
    feastDay: 'June 21',
    bio: 'Patron saint of purity and chastity. This Italian Jesuit renounced wealth and worldly pleasures to serve plague victims, dying at 23. His radical self-discipline and custody of the eyes made him the Church\'s model for overcoming temptation and controlling desire.',
    virtues: ['purity', 'chastity', 'discipline'],
    emotions: ['scattered', 'peaceful'],
    initials: 'AG',
  },
];
